...
public class StoreItemDetailAdapter extends RecyclerView.Adapter<StoreItemDetailAdapter.ViewHolder> {
    ...
    public StoreItemDetailAdapter(Context context, ArrayList<Item> data, ArrayList<String> dataId, View emptyView, ClickHandler handler) {
        mContext = context;
        mData = data;
        mDataId = dataId;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(
                R.layout.list_store_item_detail, parent, false);
